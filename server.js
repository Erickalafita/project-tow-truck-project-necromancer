...
app.get('/api', (req, res) => {
  res.json({ 
    ...
    endpoints: [
      ...
      { path: '/api/necromancy/requests', method: 'GET', description: 'Get all requests' },
      { path: '/api/necromancy/requests', method: 'POST', description: 'Create a request' },
      { path: '/api/necromancy/requests/:id', method: 'PATCH', description: 'Update a request' }
    ]
  });
});

// Auth routes - Add GET handlers
